...
class ScreenCapacity(models.Model):
    screen = models.ForeignKey(
        Screen, on_delete=models.CASCADE, related_name="screen_capacity"
    )
...
class Showtime(models.Model):
    SHOWTIME_STATUS = (("CF", "CONFIRMED"), ("CC", "CANCELLED"), ("PP", "POSTPONED"))
    movie = models.ForeignKey(Movies, on_delete=models.CASCADE)
    screen = models.ForeignKey(
        Screen, on_delete=models.CASCADE, related_name="showtimes"
    )
